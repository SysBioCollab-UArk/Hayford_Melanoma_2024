...
# This file found at https://github.com/RyanHope/Rmisc/blob/master/R/summarySE.R
# source("summarySE.R")
...
plot_timecourse(prep_dat(gene_name=mitf_targets, log_scale=TRUE), 
                ...
                savefilename=savefilename)
```
TRPM1 and EDNRB are both induce ~4-fold (2^2) after 8 days of BRAFi (in idling), even though MITF expression remains relatively stable.
...
if(SAVEPLOT) 
    pdf(file="~/Desktop/ca-genes_fold-change_heatmap.pdf", height=6, width=4)
...
```{r}
if(SAVEPLOT) 
    pdf(file="~/Desktop/mygenes_fold-change_heatmap.pdf", height=3, width=5)
