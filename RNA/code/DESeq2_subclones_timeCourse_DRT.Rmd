...
Pre-filtering and normalization is required to remove lowly expressed genes and log normalize.
...
genes_ENTREZID <- bitr(a, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Hs.eg.db)$ENTREZID
