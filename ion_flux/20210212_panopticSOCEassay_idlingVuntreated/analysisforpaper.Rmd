...
avgdn2 <- dn2 %>% 
          group_by(Time, drug1, drug1.conc, drug2) %>%
...
IQR(avgdn2$normse) #== 0.05431498
IQR(avgdn2$normse) + median(avgdn2$normse) #== 0.1130429
...
avgm[avgm$cell.line== "SKMEL5" & avgm$drug2== "CPA-Ca2+" & avgm$Time < 540 & avgm$Time > 50 , ] %>%  
 ...
 # coord_cartesian(xlim =c(60, 525), ylim = c(0.9, 2)) +
```