...
listDir = list.files(file.path("..", "data"), pattern = "*.txt", full.names=TRUE)
...
# Load platemaps
Eras = read.delim(file.path("..", "Platemaps", "ErastinDR plate map.txt"), 
                  header=TRUE, sep="\t")
RSL3 = read.delim(file.path("..", "Platemaps", "RSL3DR plate map.txt"), 
                  header=TRUE, sep="\t")
...
if(SAVEPLOTS) ggsave("RSL3-all_DRC_2024.pdf", width=3.5, height=5)
##################################
```
